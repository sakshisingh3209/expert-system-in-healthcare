...
//             <h2 className="text-xl font-bold">ExpertCare</h2>
//             <p className="mt-2 text-sm">
//             Your trusted healthcare expert system for early disease detection.
//           </p>
//           </div>
  ...
  return (
    <footer className="bg-gray-900 text-white py-8 mt-12">
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Company Info */}
        <div>
          <h2 className="text-2xl font-bold mb-2">ExpertCare</h2>
        ...
        <div>
          ...
          <p className="text-gray-400">✉️ support@expertcare.com</p>
      ...
      <div className="text-center text-gray-500 text-sm mt-8">
        © {new Date().getFullYear()} ExpertCare. All rights reserved.
      </div>
    </footer>
  );
};
